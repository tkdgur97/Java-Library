...
public class UserJFrame extends JFrame implements ActionListener{
	...
	public UserJFrame() {
		...
		mem.add(idLab);
		JLabel idPrint = new JLabel("로그인한 회원 아이디 출력");
		idPrint.setFont(new Font("굴림", Font.PLAIN, 15));
		idPrint.setBounds(216, 50, 351, 15);
		mem.add(idPrint);
		...
		mem.add(nameLab);
		JLabel namePrint = new JLabel("로그인한 회원 이름 출력");
		namePrint.setFont(new Font("굴림", Font.PLAIN, 15));
		namePrint.setBounds(216, 111, 351, 15);
		mem.add(namePrint);
		...
		mem.add(addLab);
		JLabel addPrint = new JLabel("로그인한 회원 주소 출력");
		addPrint.setFont(new Font("굴림", Font.PLAIN, 15));
		addPrint.setBounds(216, 170, 351, 15);
		mem.add(addPrint);
		...
		mem.add(gradeLab);
		JLabel gradePrint = new JLabel("로그인한 회원 등급 출력");
		gradePrint.setFont(new Font("굴림", Font.PLAIN, 15));
		gradePrint.setBounds(216, 230, 351, 15);
		mem.add(gradePrint);
